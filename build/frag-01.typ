...
<integrate-home-front-command-alerts-with-traffic-light-scada>
#strong[Section:] Siren & alert delivery
...
- During an #emph[early warning] phase \(before a red alert is confirmed), a distinct visual state — for example a flashing red — could be used at affected-area lights, providing motorists with an unambiguous visual cue even if they have not received the audible or app-based alert.
